...
import com.example.turtine.databinding.FragmentItemDetail3Binding
import com.google.android.material.dialog.MaterialAlertDialogBuilder

/**
 * [ItemDetailFragment1] displays the details of the selected item.
 */
class ItemDetail3Fragment : Fragment() {
    private val navigationArgs: ItemDetail3FragmentArgs by navArgs()

    private var _binding: FragmentItemDetail3Binding? = null
...
//        binding.itemCount.text = item.quantityInStock.toString()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentItemDetail3Binding.inflate(inflater, container, false)
        return binding.root
    }
